# Tic-Tac-Toe (Jogo da Velha) Single-Player Mode Against Bot
# This script allows a human player to play Tic-Tac-Toe against a computer-controlled opponent
# Supports three difficulty levels with increasing complexity in bot strategy

# Import os module to clear the console screen
import os
# Import random module to generate computer moves
import random
# Import time module to add delays for better user experience
import time

# Define the main game function 'Jogar_Sozinho' which takes a difficulty level parameter
def Jogar_Sozinho(Dificuldade):

    # Easy difficulty: computer makes purely random moves
    if Dificuldade == 1:

        Placar1 = 0
        Placar2 = 0

        # Main loop for repeated games or turns until exit condition
        while True:
            # Clear console for a fresh board display
            os.system('cls')
            # Initialize board cells N1 through N9 to labels 1-9
            N1 = 1
            N2 = 2
            N3 = 3
            N4 = 4
            ...
            Placar = f'* Placar *\nVocê: {Placar1}\nRobo: {Placar2}\n\n'
            # Build the visual representation of the board using current cell values
            Layout = f' {N1}  |  {N2}  |  {N3} \n----------------\n {N4}  |  {N5}  |  {N6} \n----------------\n {N7}  |  {N8}  |  {N9} \n'

            print(Placar)
            print(Layout)

            # Prompt player to start or exit the game
            Continuar = int(input('\nIniciar jogo:\n1- Sim\n2- Não\nR: '))
        ...
        # Main loop for repeated games or turns until exit condition
            ...
            # Build the visual representation of the board using current cell values
                ...
                # Check for draw: all cells are filled without a winner
        ...
        # Main loop for repeated games or turns until exit condition
                while True:
                    ...
                    # Computer selects a random available cell for 'O'
                ...
                # Display computer's chosen position
    ...
    # Medium difficulty: computer checks for immediate wins or blocks before choosing random moves
    elif Dificuldade == 2:
